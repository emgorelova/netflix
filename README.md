...
- и даже краткое содержание🧾! 
 ## Задачи📍
В начале исследования мы выделили ряд задач, решение которых представили в виде кода на Python, который написали с помощью Jupiter Notebooc.
### Заlачи, которые мы решали:
